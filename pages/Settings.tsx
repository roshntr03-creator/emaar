...
const settingsTabs = [
  ...
  { id: 'api_key', label: 'مفتاح API', icon: KeyRound },
];
...
const permissionConfig: { [module: string]: { label: string; actions: { key: PermissionAction, label: string }[] } } = {
    ...
    invoices: { label: 'الفواتير', actions: [{key: 'view', label: 'عرض'}, {key: 'create', label: 'إنشاء'}, {key: 'edit', label: 'تعديل'}, {key: 'delete', label: 'حذف'}] },
